...
- (UIImage *)imageWithTintColor:(UIColor *)tintColor insets:(UIEdgeInsets)insets
{
    ...
    return [self imageWithTintColor:tintColor rect:UIEdgeInsetsInsetRect(rect, insets)];
}

- (UIImage *)imageWithTintColor:(UIColor *)tintColor rect:(CGRect)rect
{
    return [self imageWithTintColor:tintColor rect:rect blendMode:kCGBlendModeDestinationIn alpha:1.0f];
}
...
{
    CGRect rect = CGRectMake(0.0f, 0.0f, self.size.width, self.size.height);
    return [self imageWithGradientTintColor:tintColor rect:UIEdgeInsetsInsetRect(rect, insets)];
}

- (UIImage *)imageWithGradientTintColor:(UIColor *)tintColor rect:(CGRect)rect
{
    return [self imageWithTintColor:tintColor rect:rect blendMode:kCGBlendModeOverlay alpha:1.0f];
}

- (UIImage *)imageWithTintColor:(UIColor *)tintColor blendMode:(CGBlendMode)blendMode
{
    CGRect rect = CGRectMake(0.0f, 0.0f, self.size.width, self.size.height);
    return [self imageWithTintColor:tintColor rect:rect blendMode:blendMode alpha:1.0f];
}
