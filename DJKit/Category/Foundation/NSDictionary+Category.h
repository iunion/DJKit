...
- (float)floatForKey:(nonnull id)key withDefault:(float)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
- (float)floatForKey:(nonnull id)key formatNumberStyle:(NSNumberFormatterStyle)numberStyle withDefault:(float)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
...
- (double)doubleForKey:(nonnull id)key withDefault:(double)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
- (double)doubleForKey:(nonnull id)key formatNumberStyle:(NSNumberFormatterStyle)numberStyle withDefault:(double)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
...
- (nullable NSDecimalNumber *)numberForKey:(nonnull id)key withDefault:(double)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
- (nullable NSDecimalNumber *)numberForKey:(nonnull id)key formatNumberStyle:(NSNumberFormatterStyle)numberStyle withDefault:(double)theDefault roundingScale:(short)scale roundingMode:(NSRoundingMode)mode;
